...
[source,bash, subs="+macros,+attributes"]
----
cd /home/demo-user/troubleshooting-lab/lab-materials/00-storage-odf/02-odf-file
...
[source,bash, subs="+macros,+attributes"]
----
cd /home/demo-user/troubleshooting-lab/lab-materials/00-storage-odf/01-odf-s3
