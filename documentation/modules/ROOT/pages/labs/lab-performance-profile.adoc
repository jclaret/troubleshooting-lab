...
En la configuracion desplegada encontraremos errores del tipo 
...
Se espera que el nodo aplique la configuracion del Performance Profile y reinicie el nodo perteneciente al MCP workshop.
====
...
3. **What is the status of the Tuned CRD and profiles?**
4. **Are there any errors in the Node Tuning Operator logs?**
5. **What do the tuned daemon logs show on the nodes?**
