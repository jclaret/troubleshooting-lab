...
Para este ejercicio y los siguiente crearemos un nodo y un MachineConfig Pool nuevo "workshop" para evitar esperar mucho tiempo durante los cambios que haremos en los nodos.
