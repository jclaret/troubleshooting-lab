...
2. **Check ServiceAccount and permissions:**
[.lines_space]
[.console-input]
[source,bash, subs="+macros,+attributes"]
----
...
3. **Analyze SCC selection using audit logs:**
[.lines_space]
[.console-input]
[source,bash, subs="+macros,+attributes"]
----
...
1. The ServiceAccount `module-loader` doesn't exist
...
2. **Grant SCC permissions to the ServiceAccount:**
[.lines_space]
[.console-input]
[source,bash, subs="+macros,+attributes"]
----
...
3. **Update the deployment with correct capabilities:**
[.lines_space]
[.console-input]
[source,bash, subs="+macros,+attributes"]
----
