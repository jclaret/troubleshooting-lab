...
Pay special attention to the comprehensive troubleshooting guides for general and component-specific issues:

* https://access.redhat.com/articles/4217411[Troubleshooting OpenShift] - General OpenShift troubleshooting
* https://access.redhat.com/articles/4217411[Troubleshooting OpenShift Components] - Component-specific troubleshooting guides
* https://access.redhat.com/articles/3787381[OpenShift 4.x Troubleshooting Quick Reference] - Quick reference for common issues
* https://access.redhat.com/articles/3780981[Debugging OpenShift 4.x] - Advanced debugging techniques and tools
...
# ODF/Ceph data
ll must-gather.local.8832762126482069764/registry-redhat-io-odf4-odf-must-gather*/ceph

total 392
-rw-r--r--. 1 demo-user users 353301 Sep  5 10:16 aggregated-discovery-apis.yaml
-rw-r--r--. 1 demo-user users   9644 Sep  5 10:16 aggregated-discovery-api.yaml
-rw-r--r--. 1 demo-user users   3336 Sep  5 10:16 event-filter.html
drwxr-xr-x. 2 demo-user users   4096 Sep  5 10:20 logs
drwxr-xr-x. 2 demo-user users   8192 Sep  5 10:20 must_gather_commands
drwxr-xr-x. 2 demo-user users   4096 Sep  5 10:20 must_gather_commands_json_output
drwxr-xr-x. 3 demo-user users     31 Sep  5 10:20 namespaces
-rw-r--r--. 1 demo-user users    989 Sep  5 10:16 timestamp

ll must-gather.local.8832762126482069764/registry-redhat-io-odf4-odf-must-gather*/ceph/must_gather_commands
total 3140
-rw-r--r--. 1 demo-user users    2911 Sep  5 10:16  ceph_auth_list
-rw-r--r--. 1 demo-user users     333 Sep  5 10:16  ceph_balancer_status
-rw-r--r--. 1 demo-user users    2278 Sep  5 10:16  ceph_config_dump
-rw-r--r--. 1 demo-user users    3646 Sep  5 10:16  ceph_config-key_ls
-rw-r--r--. 1 demo-user users      19 Sep  5 10:16  ceph_crash_stat
-rw-r--r--. 1 demo-user users     910 Sep  5 10:16  ceph_device_ls
-rw-r--r--. 1 demo-user users    1150 Sep  5 10:16  ceph_df_detail
-rw-r--r--. 1 demo-user users    1742 Sep  5 10:16  ceph_fs_dump
-rw-r--r--. 1 demo-user users     155 Sep  5 10:16  ceph_fs_ls
...
----
